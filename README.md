...
```ts
const jesusAFermin = {
  code: ["TypeScript", "JavaScript", ".NET", "Go", "Python", "C#"],
  tools: ["React", "Next.js", "NestJS", "AWS", "Serverless", "SQL"],
  focus: ["Fullstack Web Dev", "Scalable Systems", "API Integrations", "Cybersecurity", "Cloud Functions"],
  experience: 4,
  languages: ["English", "Spanish"],
  hobbies: ["Building projects", "Gaming", "Learning AI"]
};
```
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=ArielFJ&theme=github-dark-blue" width="98%"/>
</p>
...
* Working remotely as a fullstack engineer.
* Delivering high-impact software solutions.
* Exploring the intersection of AI, cloud architecture, and beautiful user experiences.

---

## ✨ Projects Worth Checking Out

* **[Portfolio Website](https://arielfj.com)** – Showcasing my work, skills, and projects.
* **[GitHub Repositories](https://github.com/ArielFJ?tab=repositories)** – From prototypes to production-level apps.

---

> "I don't just write code — I create meaningful, lasting web experiences that solve real problems."
